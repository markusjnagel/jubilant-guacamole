...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("SAGA POC rest-API")
            .description("SAGA POC palvelun rajapinta")
            .license("")
    ...
    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.sAGAPOCRest.base-path:/api/v1}") String basePath) {
